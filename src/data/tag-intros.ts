const tagIntros: Record<string, string> = {
  ...
  MySQL: "一条 SQL 从连接到落盘怎么走。",
  高性能后端实战:
    "从度量尺子到 CPU、内存、并发与 IO，示例用 Python / Go 对照。",
  易混专栏: "把容易搅在一起的概念拆开讲清楚。",
  进程: "进程、线程、协程分别是什么，Python 与 Go 各自怎么写、怎么选。",
  最新速递: "最近在看的内容。",
  thinking: "精读长文和手册，把方法拆开，留下自己的判断。",
  Agent: "拆开 Agent 项目的循环、工具、状态和工程取舍。",
  "Agent 拆解专栏": "把真正有意思的 Agent 项目掰开揉碎了看，不是 README 复述。",
