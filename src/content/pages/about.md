...
我平时在做和学全栈相关的东西，主 Go / TypeScript，兼 Python。最近也花不少时间在 Agent / AI 应用上：拆项目、跟实现、把踩过的坑记下来。这个博客是公开笔记本；作品和入口在 [作品站](https://duang-landing.pages.dev/)。
...
- **MySQL**：从一条 SQL 把架构、引擎和事务走一遍  
- **高性能后端实战**：从度量到 CPU / 内存 / 并发，示例 Python / Go 对照  
- **易混专栏**：把容易搅在一起的概念拆开（目前主题有进程）  
...
<ul class="about-timeline not-prose">
  ...
  <li><span class="about-timeline-when">现在</span><span class="about-timeline-what">把这些整理成公开笔记，开了后端专栏、请求过境，以及最新速递。</span></li>
</ul>
