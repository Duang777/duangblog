...
title: 解读 Anthropic《AI 原生 SDLC 手册》
featured: true
draft: false
tags:
  - thinking
description: 写代码变快之后，流程没跟上。按 Anthropic 手册把六个阶段和那套门、hook、eval 拆开，并记下判断。
revisions:
  - date: 2026-09-04
    note: 首发。按 meng shao 的解读整理，挂到 thinking。
---
...
**原文作者**：Louis Claxton（Anthropic Applied AI 团队）
**原文发布**：2026 年 8 月 21 日
...
- 原文：[The AI-Native SDLC playbook](https://claude.com/blog/the-ai-native-sdlc-playbook)
- 解读作者：meng shao（[@shao__meng](https://x.com/shao__meng)）
...
>
> — ethan du（[@du_ethan3954](https://x.com/du_ethan3954)）
