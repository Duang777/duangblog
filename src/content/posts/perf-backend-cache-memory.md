...
<svg class="perf-svg" viewBox="0 0 640 300" role="img" aria-label="寄存器 L1 L2 L3 DRAM 磁盘 六层金字塔 越下越慢越大"><rect class="perf-chip" x="280" y="20" width="80" height="36" rx="6"/><text class="perf-chip-title" x="320" y="42" text-anchor="middle">寄存器</text><text class="perf-chip-sub" x="320" y="56" text-anchor="middle">~0.1 ns · 几百 B</text><rect class="perf-chip" x="230" y="66" width="180" height="36" rx="6"/><text class="perf-chip-title" x="320" y="88" text-anchor="middle">L1 缓存</text><text class="perf-chip-sub" x="320" y="102" text-anchor="middle">~1–2 ns · 32–64 KB</text><rect class="perf-chip" x="180" y="112" width="280" height="36" rx="6"/><text class="perf-chip-title" x="320" y="134" text-anchor="middle">L2 缓存</text><text class="perf-chip-sub" x="320" y="148" text-anchor="middle">~5–10 ns · 256 KB–1 MB</text><rect class="perf-chip" x="130" y="158" width="380" height="36" rx="6"/><text class="perf-chip-title" x="320" y="180" text-anchor="middle">L3 缓存</text><text class="perf-chip-sub" x="320" y="194" text-anchor="middle">~30–50 ns · 数 MB–数十 MB</text><rect class="perf-chip" x="80" y="204" width="480" height="36" rx="6"/><text class="perf-chip-title" x="320" y="226" text-anchor="middle">主存 DRAM</text><text class="perf-chip-sub" x="320" y="240" text-anchor="middle">~100–200 ns · GB 级</text><rect class="perf-chip is-tail" x="20" y="250" width="600" height="36" rx="6"/><text class="perf-chip-title" x="320" y="272" text-anchor="middle">磁盘 SSD/HDD</text><text class="perf-chip-sub" x="320" y="286" text-anchor="middle">~ms 级 · TB 级</text></svg>
  </figure>
</section>
...
<section class="article-embed-note perf-figure">
  ...
  <figure class="perf-scene">
<svg class="perf-svg" viewBox="0 0 640 230" role="img" aria-label="Bad 结构体 bool-int64-bool 膨胀到 24 字节；Good 紧凑到 16 字节"><rect class="perf-panel" x="20" y="20" width="290" height="180" rx="8"/><text class="perf-panel-title" x="165" y="48" text-anchor="middle">Bad · bool · int64 · bool</text><rect class="perf-bar" x="40" y="72" width="26" height="40" rx="3"/><text class="perf-label" x="53" y="95" text-anchor="middle">a 1B</text><rect class="perf-bar is-tail" x="66" y="72" width="160" height="40" rx="3" fill-opacity="0.15"/><text class="perf-caption" x="146" y="95" text-anchor="middle">填充 7B</text><rect class="perf-bar" x="226" y="72" width="70" height="40" rx="3"/><text class="perf-label" x="261" y="95" text-anchor="middle">b 8B</text><rect class="perf-bar" x="40" y="122" width="26" height="40" rx="3"/><text class="perf-label" x="53" y="145" text-anchor="middle">c 1B</text><rect class="perf-bar is-tail" x="66" y="122" width="230" height="40" rx="3" fill-opacity="0.15"/><text class="perf-caption" x="181" y="145" text-anchor="middle">尾填充 7B</text><text class="perf-label is-tail" x="165" y="184" text-anchor="middle">合计 24B</text><rect class="perf-panel" x="330" y="20" width="290" height="180" rx="8"/><text class="perf-panel-title" x="475" y="48" text-anchor="middle">Good · bool · bool · int64</text><rect class="perf-bar" x="350" y="72" width="26" height="40" rx="3"/><text class="perf-label" x="363" y="95" text-anchor="middle">a 1B</text><rect class="perf-bar" x="376" y="72" width="26" height="40" rx="3"/><text class="perf-label" x="389" y="95" text-anchor="middle">c 1B</text><rect class="perf-bar is-tail" x="402" y="72" width="56" height="40" rx="3" fill-opacity="0.15"/><text class="perf-caption" x="430" y="95" text-anchor="middle">填 6B</text><rect class="perf-bar" x="458" y="72" width="140" height="40" rx="3"/><text class="perf-label" x="528" y="95" text-anchor="middle">b 8B</text><text class="perf-label" x="475" y="184" text-anchor="middle">合计 16B</text></svg>
  </figure>
</section>
...
<section class="article-embed-note perf-figure">
  ...
  <figure class="perf-scene">
<svg class="perf-svg" viewBox="0 0 640 200" role="img" aria-label="数组顺序 6.34ms，数组随机 10.27ms，链表 chasing 414ms"><text class="perf-label" x="30" y="52">数组顺序</text><rect class="perf-hbar" x="130" y="32" width="14" height="28" rx="4"/><text class="perf-label" x="160" y="52">6.34ms</text><text class="perf-label" x="30" y="104">数组随机</text><rect class="perf-hbar" x="130" y="84" width="22" height="28" rx="4"/><text class="perf-label" x="170" y="104">10.27ms · 1.62×</text><text class="perf-label" x="30" y="156">链表 chasing</text><rect class="perf-hbar is-tail" x="130" y="136" width="440" height="28" rx="4"/><text class="perf-label" x="580" y="156" text-anchor="end">414ms · 65×</text><text class="perf-caption" x="30" y="188">结论要讲准：数组乱序是小伤，链表乱跳才是重创</text></svg>
  </figure>
</section>
...
<section class="article-embed-note perf-figure">
  ...
  <figure class="perf-scene">
<svg class="perf-svg" viewBox="0 0 640 280" role="img" aria-label="核心 A 写 X 导致核心 B 整行失效，核心 B 写 Y 又让 A 失效，2.81倍慢"><text class="perf-panel-title" x="320" y="28" text-anchor="middle">同一个缓存行 · 128 字节</text><rect class="perf-panel" x="60" y="44" width="520" height="50" rx="8"/><rect class="perf-bar" x="90" y="56" width="180" height="26" rx="3"/><text class="perf-label" x="180" y="73" text-anchor="middle">X · 核心 A 写</text><rect class="perf-bar" x="430" y="56" width="120" height="26" rx="3"/><text class="perf-label" x="490" y="73" text-anchor="middle">Y · 核心 B 写</text><rect class="perf-chip" x="60" y="110" width="220" height="60" rx="8"/><text class="perf-chip-title" x="170" y="132" text-anchor="middle">核心 A L1</text><text class="perf-chip-sub" x="170" y="150" text-anchor="middle">写 X → 广播失效</text><rect class="perf-chip" x="360" y="110" width="220" height="60" rx="8"/><text class="perf-chip-title" x="470" y="132" text-anchor="middle">核心 B L1</text><text class="perf-chip-sub" x="470" y="150" text-anchor="middle">行从 S → I，重载</text><line class="perf-axis" x1="280" y1="170" x2="360" y2="170" stroke-dasharray="4 3"/><line class="perf-axis" x1="360" y1="170" x2="280" y2="190" stroke-dasharray="4 3"/><text class="perf-caption" x="320" y="200" text-anchor="middle">互相让对方失效 → 真正干活的时间被空转吃掉</text><rect class="perf-chip" x="120" y="218" width="180" height="44" rx="6"/><text class="perf-chip-title" x="210" y="238" text-anchor="middle">shared 版</text><text class="perf-chip-sub" x="210" y="256" text-anchor="middle">228.79ms</text><rect class="perf-chip" x="340" y="218" width="180" height="44" rx="6"/><text class="perf-chip-title" x="430" y="238" text-anchor="middle">padded 版</text><text class="perf-chip-sub" x="430" y="256" text-anchor="middle">81.47ms · 慢 2.81×</text></svg>
  </figure>
</section>
