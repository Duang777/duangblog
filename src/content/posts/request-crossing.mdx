...
<Marginalia>先分清是墙钟超时还是业务慢，能省掉一半的排查时间。</Marginalia>
...
<Collapsible title="请求在进程里的四段路径" open>
...
下面这个可以自己拨：选一段卡住，拖它的耗时，看先被哪个字段打掉。

<TimeoutDemo />

<Collapsible title="同一条路径的时序图">
